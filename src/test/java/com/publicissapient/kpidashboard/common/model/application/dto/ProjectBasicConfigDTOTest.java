...
public class ProjectBasicConfigDTOTest {
	...
	public void testConstructor2() {
		...
		ProjectBasicConfigDTO actualProjectBasicConfigDTO = new ProjectBasicConfigDTO(id, "projectUniqueId", "Project Name",
				"Project Display Name", "Jan 1, 2020 8:00am GMT+0100", "", "2020-03-01", "", "Jan 1, 2020 8:00am GMT+0100",
				true, new ArrayList<>(), true, true, false, 30, new ObjectId());
		actualProjectBasicConfigDTO.setConsumerCreatedOn("Jan 1, 2020 8:00am GMT+0100");
		actualProjectBasicConfigDTO.setCreatedAt("Jan 1, 2020 8:00am GMT+0100");
		ArrayList<HierarchyValueDTO> hierarchyValueDTOList = new ArrayList<>();
		actualProjectBasicConfigDTO.setHierarchy(hierarchyValueDTOList);
	...
	public void testEquals4() {
		ObjectId id = ObjectId.get();
		ProjectBasicConfigDTO projectBasicConfigDTO = new ProjectBasicConfigDTO(id, "projectUniqueId", "Project Name",
				"Project Display Name", "Jan 1, 2020 8:00am GMT+0100", "user1", "2020-03-01", "user1",
				"Jan 1, 2020 8:00am GMT+0100", true, new ArrayList<>(), true, true, true, 30, new ObjectId());
