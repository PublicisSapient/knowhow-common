...
public class HierarchyLevelServiceImplTest {
	...
	@Test
	public void testGetFullHierarchyLevels_WithAdditionalFilters_Kanban() {
		when(hierarchyLevelRepository.findAllByOrderByLevel()).thenReturn(mockHierarchyLevels);
		when(filterCategoryLevelService.getAdditionalFilterCategories()).thenReturn(mockCategories);
	...
	@Test
	public void testGetFullHierarchyLevels_WithAdditionalFilters_NotKanban() {
		when(hierarchyLevelRepository.findAllByOrderByLevel()).thenReturn(mockHierarchyLevels);
		when(filterCategoryLevelService.getAdditionalFilterCategories()).thenReturn(mockCategories);
	...
	@Test
	public void testGetProjectHierarchyLevel_EmptyTopHierarchies() {
		when(hierarchyLevelRepository.findAllByOrderByLevel()).thenReturn(Collections.emptyList());
	...
	@Test
	public void testGetSprintHierarchyLevel_EmptyTopHierarchies() {
		when(hierarchyLevelRepository.findAllByOrderByLevel()).thenReturn(Collections.emptyList());
	...
	@Test
	public void testGetReleaseHierarchyLevel_EmptyTopHierarchies() {
		when(hierarchyLevelRepository.findAllByOrderByLevel()).thenReturn(Collections.emptyList());
