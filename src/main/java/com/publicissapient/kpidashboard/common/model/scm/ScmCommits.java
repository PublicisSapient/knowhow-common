...
public class ScmCommits extends BasicModel {
	...
	/**
	 * List of file changes in this commit Each FileChange object contains details
	...
	/**
	 * Target branch name (for merge commits or when commit is intended for a
	 * specific target)
	 */
	@Indexed
	...
	public static class FileChange {
		...
		/**
		 * List of line numbers where changes occurred Contains line numbers for added,
	 ...
	 *
	 * @param threshold
	 *          the minimum number of lines to consider significant
