...
public class ScmMergeRequests extends BasicModel {
	...
	/**
	 * Direct reference to the User ID who created the merge request This field
	 * stores the User's id as a String for easier querying
	 */
	@Indexed
	private String authorUserId;

	/**
	 * List of assignee User IDs for easier querying This field stores the User ids
	 * as Strings for better performance
	 */
	@Indexed
	...
	/**
	 * List of reviewer User IDs for easier querying This field stores the User ids
	 * as Strings for better performance
	 */
	@Indexed
