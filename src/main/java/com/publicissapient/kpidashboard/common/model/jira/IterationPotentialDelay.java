...
public class IterationPotentialDelay {
	...
	public boolean equals(Object o) {
		...
		return issueId.equals(that.issueId) && dueDate
				.equals(that.dueDate) && potentialDelay == that.potentialDelay && predictedCompletedDate
						.equals(that.predictedCompletedDate) && assigneeId.equals(that.assigneeId);
	}
