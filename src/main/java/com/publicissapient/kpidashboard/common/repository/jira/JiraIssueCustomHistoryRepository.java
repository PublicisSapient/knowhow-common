...
public interface JiraIssueCustomHistoryRepository
	...
	@Query(value = "{ 'basicProjectConfigId' : ?0  }", fields = "{ 'storyID':1, 'storyType' : 1 , 'createdDate' : 1,'statusUpdationLog':1, 'fixVersionUpdationLog':1, 'sprintUpdationLog': 1, 'basicProjectConfigId': 1, 'description': 1, 'url': 1}")
	...
	List<JiraIssueCustomHistory> findByBasicProjectConfigIdAndStoryIDNotIn(String basicProjectConfigId,
			Set<String> storyID);
