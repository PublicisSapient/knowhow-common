 ...
 *
 * <p>
 * Provides data access methods for user-related operations including queries
 * for finding users by various criteria and statistics.
 */
@Repository
public interface ScmUserRepository extends MongoRepository<User, String>, ScmUserRepositoryCustom {
	 ...
	 *
	 * @param cutoffDate
	 *          the cutoff date for inactivity
	 * @param pageable
	 *          pagination information
