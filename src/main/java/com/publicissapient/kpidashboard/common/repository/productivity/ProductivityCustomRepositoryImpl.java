...
public class ProductivityCustomRepositoryImpl implements ProductivityCustomRepository {
	 ...
	 * 
	 * @param hierarchyNodeIds
	 *            Set of hierarchy entity node IDs for which to retrieve
	 *            productivity data. Must not be null or empty. These typically
	 *            represent project-level entities where productivity calculations
	 *            are stored.
	 * @param temporalAggregationUnit
	 *            The temporal unit for grouping data (e.g., WEEK, MONTH).
	 *            Determines the granularity of time-based aggregation using
	 *            MongoDB's $dateTrunc operator.
	 * @param limit
