...
public class DateUtil {
	...
	/**
	 * already a UTC Time "2023-10-02T03:51:00.000Z", in format
	...
	/**
	 * there are certain dates which are already in Z format in database, if we
	 * provide those is Z again, it will change on UI, so we need to explicitly
	 * handle that on backend
	 *
	 * @param time
	 * @return
	 */
