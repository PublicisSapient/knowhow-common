...
public class DateUtil {
     ...
     *
     * @param targetDate the date to check, not null
     * @param endDate    the date to compare against, not null
     * @return {@code true} if the target date is equal to or before the end date;
     * {@code false} otherwise
     * @throws NullPointerException if either targetDate or endDate is null
     */
     ...
     *
     * @param time 2024-10-17T23:08:15.6740000
