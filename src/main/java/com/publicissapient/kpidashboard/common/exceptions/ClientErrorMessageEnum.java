...
public enum ClientErrorMessageEnum {
	UNAUTHORIZED(401,
			"Sorry, you are not authorized to access the requested resource." + " Please check your credentials/token and try again. \n\n" + noteMessage()),
	...
	private static String noteMessage() {
		return "Note:- One or more projects using this connection are impacted. " + "Please ignore this message if the concerned processors are running successfully " + "and your KPI dashboards remain unaffected for your project.";
	}
